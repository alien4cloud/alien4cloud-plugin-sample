...
module.exports = webpackMerge.strategy(mergeStrategy)(commonConfig({ env: ENV }), {
    ...
    entry: {
        polyfills: './projects/alien4cloud-plugin-sample-addon/src/app/polyfills',
        global: './projects/alien4cloud-plugin-sample-addon/assets/styles/main.scss',
        main: './projects/alien4cloud-plugin-sample-addon/src/app/main'
    },
    output: {
    ...
    plugins: [
        ...
        new AngularCompilerPlugin({
            mainPath: utils.root('projects/alien4cloud-plugin-sample-addon/src/app/main.ts'),
